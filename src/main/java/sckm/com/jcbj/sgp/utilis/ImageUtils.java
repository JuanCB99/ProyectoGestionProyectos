 ...
 */
package sckm.com.jcbj.sgp.utilis;
...
// MAS RAPIDO a partir de 1.4
            ...
            System.out.println("error al intentar leer la im�gen");
            return null;
        }
        return image;
    ...
    /**
     * comprueba que la im�gen tiene un m�nimo en pixels width y height tienen
     * que tener un tama�o igual o mayor que el pasado como argumento
     *
     ...
     *
     *
     * public static boolean isGreaterThanMinSize(int w, int h, BufferedImage
     * imgSrc){ int nHeight = imgSrc.getHeight(); int nWidth =
     * imgSrc.getWidth(); if ((nHeight return false; } else { return true; } }
     *
     * /*
     * calcula el factor de escala m�nimo y en base a eso escala la imagen seg�n
     * el dicho factor.
